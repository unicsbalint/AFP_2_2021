...
<head>
    ...
    <link rel="stylesheet" href="y_style.css">

    <script src="orderY.js"></script>
...
<section class="bgimage">
    <div id="heroText">THE MODEL Y</div>
</section>
...
<div class="album p-5 mx-5 bg-light">
    <div class="row justify-content around">
        <div class="col-md-4">
            <div class="col-m-4"><h2>Description about MODEL Y</h2></div>
            <div class="row align-items-start">
                <div class="col m-4" style="width: 500px; background-color: rgba(255, 255, 255, 0.411);">
                    Pick an astonishing color for your new MODEL Y
